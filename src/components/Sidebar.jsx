...
export default function Sidebar() {
  return (
    <aside role="navigation" aria-label="Main navigation" className="min-h-screen w-20 md:w-72 bg-gradient-to-b from-[#4b2bc2] via-[#7e21c9] to-[#9f1dd9]">
      <ul className="text-gray-100 w-3/4 mx-auto py-12">
        ...
        <li className="flex items-center px-4 rounded-xl mb-5 py-2 focus:bg-white/20 hover:bg-white/10 cursor-pointer">
          ...
          <Link to="/transactions" title="Transactions" className="hidden md:inline">
            Transactions
          </Link>
        </li>
        <li className="flex items-center px-4 rounded-xl mb-5 py-2 focus:bg-white/20 hover:bg-white/10 cursor-pointer">
          ...
          <Link to="/parametres" title="Paramètres" className="hidden md:inline">Paramètres</Link>
        </li>
      </ul>
    </aside>
  );
